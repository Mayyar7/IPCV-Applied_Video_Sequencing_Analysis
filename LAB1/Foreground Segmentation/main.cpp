...
int main(int argc, char ** argv)
{
	...
	//string dataset_path = "/home/smriti/Documents/AVSA/Lab1/AVSA_LAB1_dataset2012lite/dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
	...
	string dataset_path = "/home/smriti/Documents/AVSA/Lab1/shadow/"; //SET THIS DIRECTORY according to your download
	string dataset_cat[1] = {"shadow"};
	string baseline_seq[6] = {"backdoor","bungalows","busStation","copyMachine","cubicle","peopleInShade"};
	string image_path = "/input/in%06d.jpg"; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001

	/***Preliminary Dataset ***/

	//string dataset_path = "/home/smriti/Documents/AVSA/Lab1/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
	...
	/***Dynamic Background***/
	//string dataset_path = "/home/smriti/Documents/AVSA/Lab1/dynamicBackground/"; //SET THIS DIRECTORY according to your download
	//string dataset_cat[1] = {"dynamicBackground"};
	//string baseline_seq[6] = {"boats","canoe","fall","fountain01","fountain02","overpass"};
	//string image_path = "/input/in%06d.jpg"; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001



	string project_root_path = "/home/smriti/Documents/AVSA/Lab1"; //SET THIS DIRECTORY according to your project
	...
	for (int c=0; c<NumCat; c++ )
	{
		...
		for (int s=0; s<NumSeq; s++ )
		{
			...
			fgseg::bgs avsa_bgs(tau,rgb, shadow_removal, alpha, selective_bkg_update, threshold_ghosts2); //construct object of the bgs class
