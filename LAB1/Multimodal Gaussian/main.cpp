...
//
	string dataset_path = "C:\\Users\\Mili\\Documents\\IPCV\\UAM Lectures\\Applied Video Sequence Analysis\\Lab 1\\AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "C:\\Users\\Mili\\Documents"; //SET THIS DIRECTORY according to your project
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			double tau =2.5 ; // to set ... //Lab1.1.1-310
			double alpha=0.01; // to set ... //Lab1.1.2-3
			...
			//fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, rgb); //construct object of the bgs class //Lab1.1.2
			fgseg::bgs avsa_bgs(tau, rgb, alpha, selective_bkg_update, threshold_ghosts2); //construct object of the bgs class
