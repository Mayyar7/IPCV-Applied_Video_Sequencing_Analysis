...
int main(int argc, char ** argv) 
{
	...
	for (int c=0; c<NumCat; c++ )
	{
		...
		for (;;) {
			...
			classifyBlobs(bloblistFiltered, dist_metric);
			...
			classifyBlobs(sbloblistFiltered, dist_metric);
			...
			Mat bt= paintBlobImage(frame,bloblistFiltered, true); 	//Classified Blobs
			Mat bf = paintBlobImage(frame,bloblistFiltered, false);	//Detected Blobs
			Mat bs_t = paintBlobImage(frame,sbloblistFiltered, true);//Stationary Classified Blobs
			Mat bs_f= paintBlobImage(frame,sbloblistFiltered, false);//Stationary Detected Blobs
