...
int main(int argc, char ** argv)
{
	...
	string inputvideo = "/home/smriti/Documents/AVSA/Lab3/AVSA_Lab3_datasets/dataset_lab3/lab3.2/video2.mp4";
	if(argc==2)
	{
		inputvideo = argv[1];
	}
	...
	/* Learning rate to set for each video in Task 3.2: Video2: 0.001, Video3: -1, Video5:-1, Video6=0.001*/

	double learningrate = 0.001; 												//default value (as starting point)
	double history = 50;
	double varThreshold = 16;
	int min_width = 50; 														// the minimum width for the blob to be added to the list
	int min_height = 50; 														// the minimum height for the blob to be added to the list
