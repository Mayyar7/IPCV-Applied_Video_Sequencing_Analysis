...
#include "GradientTracker.hpp"																		//Header file for GradientTracker
...
int main(int argc, char ** argv)
{
	...
	// Dataset paths
	std::string sequences[] = {"bolt1",	"basketball","ball2",};										//test data
	...
	for (int s=0; s<NumSeq; s++ )
	{
		...
		//Initialise the object of GradientTracker class with parameters
		GradientTracker Object = GradientTracker(list_bbox_gt[0],stride,bins,numCandidates);
		Rect estimated;
